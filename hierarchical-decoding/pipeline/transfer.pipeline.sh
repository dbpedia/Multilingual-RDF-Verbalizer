...
ordering_model="/home/marcosbc/model/tr.ordering"
structuring_model="/home/marcosbc/model/tr.structuring"
lexicalization_model="/home/marcosbc/model/tr.lexicalization"
...
python $project_dir/Translate.py -input $project_dir/data/en/end2end/$set.eval -gpu \
				...
				-src-vocab $project_dir/vocab/tied.vocab.json -mtl
