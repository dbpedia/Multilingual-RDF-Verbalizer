...
python $project_dir/utils/generate.py $pipeline_dir/lexicalization.cs.$set $pipeline_dir/ordering.$set $pipeline_dir/reg.$set neuralreg $neuralreg_dir $project_dir/data/en/reg
