...
def main():
    ...
    parser.add_argument('-algorithm', "--algorithm", nargs='*', type=str, choices=['rnd', 'wl'])
    ...
    parser.add_argument('-window', "--window-size", type=int, nargs='*') #, default=5
    ...
    for algorithm in args.algorithm:
        ...
        print("Loading the knowledge graph by using", algorithm, "...")
        kg = load_knowledge_graph(args.dbpedia, strategy=algorithm)
        ...
        for window_size in args.window_size:
            embeddings = generate_embeddings(kg, vocab_dataset, args.embedding_size, walkers=walker, n_jobs=args.jobs, window_size=window_size, sg=sg, max_iter= args.max_iter, negative=args.negative_sampling, min_count=args.min_count)
