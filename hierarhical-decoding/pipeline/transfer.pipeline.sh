...
python $project_dir/Train.py -train-src $project_dir/data/en/lexicalization/train.src -train-tgt $project_dir/data/en/lexicalization/train.bpe.1.trg -dev-src $project_dir/data/en/lexicalization/dev.src -dev-tgt $project_dir/data/en/lexicalization/dev.bpe.1.trg -mtl -batch-size 32 -max-length 180 -lr 0.0005 -seed 13 -hidden-size 512 -enc-layers 4 -dec-layers 4 -enc-filter-size 2048 -dec-filter-size 2048 -enc-num-heads 8 -dec-num-heads 8 -enc-dropout 0.1 -dec-dropout 0.1 -steps 200000 -eval-steps 5000 -print-every 1000 -warmup-steps 8000 -gpu -eval $pipeline_dir/structuring.mapped.dev -test $pipeline_dir/structuring.mapped.test -save-dir /home/marcosbc/results/output.11082020/tr.lexicalization/ -tie-embeddings -translate -beam-size 5 -src-vocab /home/marcosbc/Multilingual-RDF-Verbalizer/pytorch/vocab/tied.vocab.json

for set in dev test
do
mv /home/marcosbc/results/output.11082020/tr.lexicalization/structuring.mapped.$set.0.out $pipeline_dir/lex.$set
