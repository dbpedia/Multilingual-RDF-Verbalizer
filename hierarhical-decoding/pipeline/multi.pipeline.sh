...
python Train.py -train-src data/en/multi/train.src -train-tgt data/en/multi/train.trg -dev-src data/en/multi/dev.src -dev-tgt data/en/multi/dev.trg -mtl -batch-size 32 -max-length 180 -lr 0.0005 -seed 13 -hidden-size 512 -enc-layers 4 -dec-layers 4 -enc-filter-size 2048 -dec-filter-size 2048 -enc-num-heads 8 -dec-num-heads 8 -enc-dropout 0.1 -dec-dropout 0.1 -steps 200000 -eval-steps 5000 -print-every 1000 -warmup-steps 8000 -gpu -eval $pipeline_dir/ordering.mapped.multi.dev -test $pipeline_dir/ordering.mapped.multi.test -save-dir $model_dir/multi/ -tie-embeddings -translate -beam-size 5

for set in dev test
do
mv $model_dir/multi/ordering.mapped.multi.$set.0.out $pipeline_dir/structuring.$set
...
python Train.py -train-src data/en/multi/train.src -train-tgt data/en/multi/train.trg -dev-src data/en/multi/dev.src -dev-tgt data/en/multi/dev.trg -mtl -batch-size 32 -max-length 180 -lr 0.0005 -seed 13 -hidden-size 512 -enc-layers 4 -dec-layers 4 -enc-filter-size 2048 -dec-filter-size 2048 -enc-num-heads 8 -dec-num-heads 8 -enc-dropout 0.1 -dec-dropout 0.1 -steps 200000 -eval-steps 5000 -print-every 1000 -warmup-steps 8000 -gpu -eval $pipeline_dir/structuring.mapped.multi.dev -test $pipeline_dir/structuring.mapped.multi.test -save-dir $model_dir/multi/ -tie-embeddings -translate -beam-size 5

for set in dev test
do
mv $model_dir/multi/structuring.mapped.multi.$set.0.out $pipeline_dir/lex.$set
