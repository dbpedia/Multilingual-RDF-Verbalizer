...
#for set in dev test
#do
#mv /home/marcosbc/results/output.03082020/ordering/$set.eval.0.out $pipeline_dir/ordering.$set
...
#$moses/scripts/tokenizer/normalize-punctuation.perl -l $lng < $pipeline_dir/lexicalization.cs.$set > $pipeline_dir/lexicalization.punc.$set
#$moses/scripts/tokenizer/detokenizer.perl -l $lng < $pipeline_dir/lexicalization.punc.$set > $pipeline_dir/lexicalization.$set
